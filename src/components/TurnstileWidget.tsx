...
export function TurnstileWidget({
  ...
  // Keep a stable ref to the latest onToken to avoid re-rendering the widget
  // when parent re-renders (which can cause “Verifying…” loops).
  ...
  useEffect(() => {
    ...
    // Intentionally NOT depending on `onToken` to avoid widget re-init loops.
